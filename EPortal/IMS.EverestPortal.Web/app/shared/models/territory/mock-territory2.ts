...
//export const LEVEL1_GROUP: Group = { Id: 1, GroupNumber: '11', CustomGroupNumber: '', Name: 'Australia', IsOrphan: false, PaddingLeft: 130, ParentId: null, Children: null };
//export const LEVEL2_GROUPS: Group[] = [
//    { Id: 2, GroupNumber: '21', CustomGroupNumber: '', Name: 'NSW', IsOrphan: false, PaddingLeft: 130, ParentId: 1, Children: null },
//    { Id: 2, GroupNumber: '22', CustomGroupNumber: '', Name: 'VIC', IsOrphan: false, PaddingLeft: 130, ParentId: 1, Children: null }
//];
...
export const MOCK_TERRITORY2: Territory = territory;
