...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DBScript_InitTables]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[DBScript_InitTables]
GO
