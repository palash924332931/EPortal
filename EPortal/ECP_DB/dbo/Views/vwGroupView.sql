...
AS
SELECT a.Id, a.AttributeId, a.ParentId, c.GroupId, a.IsAttribute, c.Name AS groupname, b.Name AS attributename, b.OrderNo, b.MarketDefinitionId, c.GroupOrderNo
