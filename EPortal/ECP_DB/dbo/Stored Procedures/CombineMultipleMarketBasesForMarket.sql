CREATE PROCEDURE [dbo].[CombineMultipleMarketBasesForMarket]
...
BEGIN
	...
	(
		...
		where MarketDefinitionId = @pMarketDefinitionId and 
	...
	from(
		...
		from(
			...
			(
				...
				from MarketDefinitionPacks
				where 
				MarketDefinitionId = @pMarketDefinitionId and 
				MarketBaseId is not null --
			)A
...
--EXEC [dbo].[CombineMultipleMarketBasesForMarket] 1