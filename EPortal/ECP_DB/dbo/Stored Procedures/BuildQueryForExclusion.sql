...
CREATE PROCEDURE [dbo].[BuildQueryForExclusion] 
AS
BEGIN
	SET NOCOUNT ON;
	truncate table PackExclusionQuery
	...
	select * into #loopTable4 from MarketDefinitions --where id = 58
		...
		begin
			...
			EXEC [dbo].[BuildQueryForExclusionMarketDef] @MarketDefinitionId = @pMarketDefinitionId
